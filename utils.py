...
def line_detection(img):
    high_thresh, thresh_im = cv2.threshold(cv2.cvtColor(img, cv2.COLOR_BGR2GRAY), 0, 255,
...
def refine_boundary(img, area_min):
    ###area_min: Minimum area for contour detection##
